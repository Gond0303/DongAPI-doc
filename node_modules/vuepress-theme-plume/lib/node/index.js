...
function resolvePageHead(page, localeOptions) {
  ...
  if (localeOptions.appearance ?? true) {
    ...
    page.frontmatter.head.push([
      "script",
      { id: "check-dark-mode" },
      appearance === "force-dark" ? `document.documentElement.dataset.theme = 'dark'` : `;(function () {
...
import { entries as entries4, getRootLangPath as getRootLangPath2 } from "@vuepress/helper";
...
import { entries as entries5, isLinkAbsolute as isLinkAbsolute2, isLinkHttp, isPlainObject as isPlainObject2 } from "@vuepress/helper";
...
function getSidebarData(app, locales) {
  ...
  entries6(locales).forEach(([localePath, sidebar]) => {
    ...
    } else if (isPlainObject3(sidebar)) {
