...
declare const docsearchPlugin: ({ injectStyles, indexBase, ...options }?: DocSearchPluginOptions) => Plugin;

export { type DocSearchLocaleOptions, type DocSearchOptions, type DocSearchPluginOptions, docsearchPlugin as default, docsearchPlugin };
